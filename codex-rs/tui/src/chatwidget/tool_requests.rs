...
impl ChatWidget {
    ...
    pub(crate) fn note_remote_im_exec_approval_resolved(
        &mut self,
        approval_id: &str,
        decision: Option<&CommandExecutionApprovalDecision>,
        source: Option<crate::app::app_server_requests::ExecApprovalResolutionSource>,
    ) {
